  ...
  assets: {
    ...
    bootstrap: {
      ...
      filter: function (module, regex, options, log) {
        function is_bootstrap_style(name) { // eslint-disable-line
          return name.indexOf('./src/theme/bootstrap.config.js') >= 0;
        }
        if (options.development) {
          return is_bootstrap_style(module.name) && WebpackIsomorphicToolsPlugin.style_loader_filter(module, regex, options, log); // eslint-disable-line
        }
